	...
	nodes:[
		{
			...
			icon:'../images/MenuIcon/yiqishebeiguanli.gif',//结点的图标
			name:'仪器设备管理'
		},{
			mid:'ac',
			pid:'aa',
	...
	nodes:[
		{
			...
			target:'mainFrame',
			url:'../system/deviceUserAction_home.do',
			isParent:false
		},{
			mid:'ao',
			pid:'am',
			...
			target:'mainFrame',
			url:'../system/deviceRoleAction_home.do',
			isParent:false
		},{
			mid:'ap',
			pid:'am',
			...
			target:'mainFrame',
			url:'../system/deviceCommonMsgAction_home.do',
			isParent:false
		},{
			mid:'aq',
			pid:'am',
			...
			target:'mainFrame',
			url:'../system/deviceSystemDDLAction_home.do',
			isParent:false
		}
	]
}, {
