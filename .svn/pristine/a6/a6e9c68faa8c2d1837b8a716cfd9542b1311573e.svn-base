  ...
  <div class="contant">
   	<div class="conBg">
        <div class="yan_zheng resetpassword">
		    <h3 class="loginTit4">账号激活</h3>
        	<p class="loginDes5"></p>
			<p class="pdTop">我们已向<em><s:property value="userEmail.email"/></em>发送账号激活邮件，请登录邮箱点击激活账号。</p>
            <a href="http://mail.qq.com/" class="btn btn-normal217 btn-success marginT20">进入邮箱查看</a>
			<dl class="yanz_dl">
